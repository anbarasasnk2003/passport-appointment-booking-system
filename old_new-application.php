...
mysql_query("insert into `new_applicants`(pnum,phone,vnum,vsdate,vedate,vtype,city,cformid,fcname,email,cfile,nationality,status,addr)values('$pnum','$uphone','$vnum','$vsdate','$vedate','$vtype','$city','$cformid','$fname','$uemail','$cfile','$nationality','Applied for Residential Permit','$addr')")or die(mysql_error());
